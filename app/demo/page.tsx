    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          <Link href="/dashboard" className="-ml-16 pb-1">
            <Image
              src={
                theme === 'dark'
                  ? '/logo-dark.png'
          ...
          <div className="rounded-lg border bg-card">
            <div className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Demo data - sign up to track your own applications!
              </p>
            </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div
                          ...
                          style={{width: `${(appliedJobs / totalJobs) * 100}%`}}></div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div
                          ...
                          style={{width: `${(interviewJobs / totalJobs) * 100}%`}}></div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div
                          ...
                          style={{width: `${(offerJobs / totalJobs) * 100}%`}}></div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div
                          ...
                          style={{width: `${(rejectedJobs / totalJobs) * 100}%`}}></div>
                      </div>
